...
FitPlanHub is a full-stack fitness platform where certified trainers design and publish paid fitness plans, and users can subscribe, follow trainers, and access structured, goal-oriented fitness content.

The project showcases a real-world backend architecture with JWT-based authentication, role-based access control, and a modern React frontend integrated with a FastAPI backend.
...
View and manage plans created by them
...
Non-subscribed users can view plan previews only
...
Application sets global auth state
